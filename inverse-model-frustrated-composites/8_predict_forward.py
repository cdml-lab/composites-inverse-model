...
if __name__ == "__main__":
    ...
    model.load_state_dict(torch.load(r'C:\Users\user\OneDrive - Technion\Documents\GitHub\public-repo\inverse-model-frustrated-composites\saved_models_for_checks\17-24_Curvature_Features_20240923.pkl', map_location=device))
    ...
    with torch.no_grad():
        predicted_xyz = model(initial_fiber_orientation).permute(0, 2, 3, 1).squeeze(0).cpu().numpy()
