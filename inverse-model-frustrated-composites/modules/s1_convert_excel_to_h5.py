...
def definitions():
    ...
    return dataset_name, split_percentages, suffixes, script_dir, project_root, base_dir, hdf5_file_path, input_files_list, output_files_list
...
def s1_convert_excel_to_h5(name, base_dir, input_files_list, output_files_list, split_percentages, suffixes, output_folder, split_indices=None, smoothing_method=None):
    ...
    output_files_list = [base_dir / file for file in output_files_list]
